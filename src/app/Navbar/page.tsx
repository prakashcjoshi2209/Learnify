...
//         {/* Search Bar */}
//         <div className="flex items-center bg-white text-gray-700 rounded-full px-3 py-2 mx-4 flex-grow max-w-[300px]">
...
//           <Link href="/ExploreData" className="hover:underline">Explore</Link>
