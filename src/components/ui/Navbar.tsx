...
//               <button
//                 onClick={() => handleNavigation("/")}
//                 className={`text-gray-800 hover:text-purple-600 ${pathname === "/" ? "font-bold" : ""}`}
//               >
//                 Home
//               </button>
//               <button
//                 onClick={() => handleNavigation("/ExploreData")}
//                 className={`text-gray-800 hover:text-purple-600 ${pathname === "/ExploreData" ? "font-bold" : ""}`}
//               >
//                 Explore
//               </button>
//               {session && (
//                 <button
//                   onClick={() => handleNavigation("/DashBoard")}
//                   className={`text-gray-800 hover:text-purple-600 ${pathname === "/DashBoard" ? "font-bold" : ""}`}
//                 >
//                   Dashboard
//                 </button>
//               )}
